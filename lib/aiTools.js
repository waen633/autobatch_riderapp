...
module.exports = [
...

  {
    ...
    function: {
      ...
      description: 'ดึงรายละเอียด order — ใช้ตอบ "order นี้ถึง status อะไรแล้ว", "ยืนยันสินค้าแล้วหรือยัง", "rider คนไหน deliver"',
      parameters: {
        type: 'object',
        properties: {
          type: {
            ...
            description: '"consignment" ถ้าให้เลข consignment, "orderid" ถ้าให้ order ID'
          },
          values: {
            type: 'string',
            description: 'เลข consignment หรือ order ID คั่นด้วย comma'
          }
        },
...

  {
    ...
    function: {
      ...
      description: 'เช็คว่า customer ยืนยันสินค้าแล้วหรือยัง (ค้นใน CLS log) — ใช้ตอบ "order นี้ confirm แล้วไหม", "ลูกค้ากด confirm หรือยัง"',
      parameters: {
        type: 'object',
        properties: {
          orderId: { type: 'string', description: 'Order ID ที่ต้องการเช็ค' }
        },
        required: ['orderId']
      }
    }
